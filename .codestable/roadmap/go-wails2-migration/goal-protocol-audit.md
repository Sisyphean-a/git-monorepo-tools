...
写 `.codestable/roadmap/go-wails2-migration/goal-audit.md`：
...
同时写 `.codestable/roadmap/go-wails2-migration/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
