...
- `.codestable/roadmap/go-wails2-migration/goal-state.yaml`
- `.codestable/roadmap/go-wails2-migration/goal-plan.md`
- `.codestable/roadmap/go-wails2-migration/go-wails2-migration-roadmap.md`
- `.codestable/roadmap/go-wails2-migration/go-wails2-migration-items.yaml`
- `.codestable/roadmap/go-wails2-migration/goal-features/*.md`
- `.codestable/roadmap/go-wails2-migration/goal-protocol-feature-loop.md`
- `.codestable/roadmap/go-wails2-migration/goal-protocol-gates.md`
- `.codestable/roadmap/go-wails2-migration/goal-protocol-audit.md`
...
用户粘贴 `/goal` 代表授权 goal 会话连续执行各 feature 的 impl / review / QA / accept。普通流程中逐 feature 停等用户确认的 checkpoint，在 goal 模式下改为写入报告、状态和审计记录。
...
Plan: .codestable/roadmap/go-wails2-migration/goal-plan.md
Protocol: .codestable/roadmap/go-wails2-migration/goal-protocol.md
```
